                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        <td style="background:#2563eb; padding:25px; text-align:center;">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR1HE51g1QFrOdlhF0eLqVjsYNknuh_bIdCYqjAj1sg3g&s=10"
                                style="width: 50px;margin-bottom:10px;border-radius:50%;" alt="">
                    ...
                    <tr>
                        <td style="padding:40px 35px;">
                            ...
                            <div
                                style="background:#f8fafc; border-left:4px solid #2563eb; padding:15px 20px; margin:25px 0;">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="background:#2563eb; border-radius:6px;">
                                        {{-- <a href=" http://lara-project.test/users/{{ $user->id }}" style="display:inline-block; padding:13px 24px; color:#ffffff;
                              text-decoration:none; font-size:15px; font-weight:bold;">
                                            View My Profile
                                        </a> --}}
                                        <a href="{{ route('users.show',['user'=> $user->id]) }}" style="display:inline-block; padding:13px 24px; color:#ffffff;
                              text-decoration:none; font-size:15px; font-weight:bold;">
                                            View My Profile
                                        </a>
                                    </td>

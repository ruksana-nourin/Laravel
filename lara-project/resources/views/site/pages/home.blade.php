                ...
                <div class="bento">
                    ...
                    <article class="bento-card bento-card--lg">
                        ...
                        <div>
                            ...
                            <p>Apple ecosystem with high-quality audio playback while serving as a hub for controlling smart
                                home devices. Spatial audio, room-sensing tech.</p>
        ...
        <section class="section" style="padding-top: var(--s5)">
            <div class="container">
                ...
                <div class="tabs" role="tablist">
                    ...
                    <!-- Watch Tab -->
                    <button class="tab" type="button" role="tab" aria-selected="false" data-target="#watch-products">
                        Watch
                    </button>

                    <!-- Camera Tab -->
                    <button class="tab" type="button" role="tab" aria-selected="false" data-target="#camera-products">
                        Camera
                    </button>

                    <!-- Accessories Tab -->
                    <button class="tab" type="button" role="tab" aria-selected="false" data-target="#accessories-products">
                        Accessories
                    </button>

                    <!-- Speaker Tab -->
                    <button class="tab" type="button" role="tab" aria-selected="false" data-target="#speaker-products">
                        Speaker
                    </button>
